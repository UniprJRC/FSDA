...
%                  envelope. The default is to add an envelope based on all
%                  the observations (size n envelope)
%               Example - 'envm',n 
%               Data Types - double
%
...
%                   the lines associated with the envelopes. Default is
%                   lwdenv=1
%                   Example - 'lwdenv',2
%                   Data Types - double
%
...
%                   brushed units labeladd.
%                   If this option is '1', we label the units
...
%                   Data Types - char 
%
%        scaled :   scaled or unscaled envelopes. Boolean. Use reference
%                   (envelopes scaled or unscaled). If scaled=1 the
%                   envelopes are produced for scaled Mahalanobis distances
%                   (no consistency factor is applied) else the traditional
%                   consistency factor is applied.
...
options=struct('quant', quant,'mplus1',0,...
