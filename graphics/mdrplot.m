...
%    out.mdr =  minimum deletion residual. A matrix containing the
%               monitoring of minimum deletion residual in each step of the
%               forward search. The first column of mdr must contain the
%               fwd search index This matrix can be created using function
%               FSReda (compulsory argument)
%       out.Un  =   order of entry of each unit. Matrix containing the
%                   order of entry of each unit
...
%     out.Bols  =   Monitoring of beta coefficients. (n-init+1) x (p+1)
%                    matrix containing the monitoring of
%               estimated beta coefficients in each step of the forward
%               search (necessary only if option databrush is not empty and
...
%                   specifies if it is necessary to plot the curve
%                   associated with (m+1)th order statistic.
%                   Example - 'mplus1',1
%                   Data Types - double
%
...
%                   minimum deletion residual. Default line width=2
%                   Example - 'lwd',3
%                   Data Types - single | double 
%
