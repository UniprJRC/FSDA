...
%   bc                             - Returns the Binomial coefficient                                                                                                    - UTICOMB             - 2023 Sep 08
%   biplotFS                       - Calls biplotAPP.mlapp to show a dynamic biplot                                                                                      - VIS-Mult            - 2023 Mar 09
%   boxcoxR                        - Finds MLE of lambda in linear regression (and confidence interval) using Box Cox, YJ or extended YJ  transformation                 - REG-Transformations - 2023 Sep 30
...
%   brushFAN                       - Displays a GUI which enables brushing in the fanplot                                                                                - GUI                 - 2023 Nov 02
...
%   carbikeplot                    - Produces the carbike plot to find best relevant clustering solutions                                                                - VIS-Clu             - 2023 Sep 20
...
%   ClusterRelabel                 - Enables to control the labels of the clusters which contain predefined units                                                        - UTISTAT             - 2023 Sep 08
%   combsFS                        - Is an iterative algorithm equivalent to the MATLAB combs.m                                                                          - UTICOMB             - 2023 Sep 08
%   CorAna                         - Performs correspondence analysis                                                                                                    - MULT-Categorical    - 2023 Aug 23
%   CorAnaplot                     - Draws the Correspondence Analysis (CA) graphs with confidence ellipses                                                              - VIS-Mult            - 2023 Sep 18
...
%   ctlcurves                      - Computes Classification Trimmed Likelihood Curves                                                                                   - CLUS-RobClaMULT     - 2023 Sep 08
...
%   dempk                          - Performs a merging of components found by tkmeans                                                                                   - CLUS-RobClaMULT     - 2023 Sep 08
%   distribspec                    - Plots a probability density function between specification limits                                                                   - UTISTAT             - 2023 Oct 03
...
%   fanBIC                         - Uses the output of FSRfan to choose the best value of the transformation parameter in linear regression                             - VIS-Reg             - 2023 Nov 02
%   fanBICpn                       - Uses the output of FSRfan called with input option family 'YJpn' to choose la_P and la_N                                            - VIS-Reg             - 2023 Nov 02
%   fanplot                        - Plots the fan plot (this function will be replaced by fanplotFS)                                                                    - VIS-Reg             - 2023 Nov 02
%   fanplotFS                      - Plots the fan plot for transformation in linear regression or deletion t stat                                                       - VIS-Reg             - 2023 Nov 02
...
%   forecastH                      - Produce forecasts with confidence bands for regression model with heteroskedasticity                                                - REG-Hetero          - 2023 May 29
%   forecastTS                     - Forecast for a time series with trend, time varying seasonal, level shift and irregular component                                   - REG-Regression      - 2023 Nov 02
...
%   FSMmmdrs                       - Performs random start monitoring of minimum Mahalanobis distance                                                                    - CLUS-RobClaMULT     - 2023 Sep 08
...
%   FSRaddt                        - Produces t deletion tests for each explanatory variable                                                                             - REG-ModelSelection  - 2023 Sep 20
...
%   FSRfan                         - Monitors the values of the score test statistic for each lambda                                                                     - REG-Transformations - 2023 Nov 02
...
%   FSRmdrrs                       - Performs random start monitoring of minimum deletion residual                                                                       - CLUS-RobClaREG      - 2023 Sep 08
...
%   genSigmaGPCM                   - Generates covariance matrix for the 14 Gaussian Parsimonious Clustering Models                                                      - CLUS-RobClaMULT     - 2023 Sep 08
%   GowerIndex                     - Computes matrix of similarity indexes using Gower metric                                                                            - CLUS-RobClaMULT     - 2023 Sep 08
...
%   GUImad                         - Shows the necessary calculations to obtain MAD, S_M or S_Me in a GUI                                                                - GUI                 - 2023 May 30
...
%   GUItrimmean                    - Shows the necessary calculations to obtain the trimmed mean in a GUI                                                                - GUI                 - 2023 Nov 02
...
%   htmlwriteFS                    - Is an obsolete function which will be removed in future releases. Use publishFS.m instead                                           - UTIHELP             - 2023 Sep 08
...
%   lexunrank                      - Gives the the $k$-combination of $n$ elements of position $N$ in the lexicographic order of all combinations                        - UTICOMB             - 2023 Sep 08
%   lga                            - Performs linear grouping analysis                                                                                                   - CLUS-RobClaREG      - 2023 Sep 08
%   logmvnpdfFS                    - Produces log of Multivariate normal probability density function (pdf)                                                              - ProbDist            - 2022 Dec 02
%   LTSts                          - Extends LTS estimator to time series                                                                                                - REG-Regression      - 2023 Oct 31
%   LTStsLSmult                    - Extends LTSts to the detection of multiple Level Shifts in time series                                                              - REG-Regression      - 2023 Jun 15
%   LTStsVarSel                    - Does variable selection in the robust time series model LTSts                                                                       - REG-Regression      - 2023 Apr 19
%   LXS                            - Computes the Least Median of Squares (LMS) or Least Trimmed Squares (LTS) estimators                                                - REG-Regression      - 2023 Jun 15
...
%   makecontentsfileFS             - Extends Matlab function makecontentsfile                                                                                            - UTIHELP             - 2023 Sep 08
...
%   mdrplot                        - Plots the trajectory of minimum deletion residual (mdr)                                                                             - VIS-Reg             - 2023 Jul 14
%   mdrrsplot                      - Plots the trajectory of minimum deletion residual from random starts                                                                - CLUS-RobClaREG      - 2023 Jun 19
%   medcouple                      - Computes the medcouple, a robust skewness estimator                                                                                 - UTISTAT             - 2022 Nov 10
%   MixSim                         - Generates k clusters in v dimensions with given overlap                                                                             - CLUS-MixSim         - 2023 Oct 31
%   MixSimreg                      - Generates k regression hyperplanes in p dimensions with given overlap                                                               - CLUS-MixSim         - 2023 Sep 08
...
%   MMreg                          - Computes MM estimator of regression coefficients                                                                                    - REG-Regression      - 2023 May 29
...
%   moonplot                       - Draws the Correspondence Analysis (CA) moonplot                                                                                     - VIS-Mult            - 2023 Jul 20
%   mreadFS                        - Enables to create a structure with InputArgs/OptArgs/OutArgs ... from .m function files (OBSOLETE FUNCTION REPLACED BY publishFS.m) - UTIHELP             - 2023 Sep 08
...
%   nchoosekFS                     - Returns the Binomial coefficient or matrix containing all combinations                                                              - UTICOMB             - 2023 Sep 08
...
%   overlap                        - Computes the exact overlap given the parameters of the mixture                                                                      - CLUS-MixSim         - 2023 Sep 08
%   overlapmap                     - Produces an interactive overlap map                                                                                                 - CLUS-RobClaMULT     - 2023 Sep 08
...
%   publishBibliography            - Enables to create web page which contains the references inside the input .m files                                                  - UTIHELP             - 2023 Sep 08
%   publishFS                      - Enables to create automatic HELP FILES from structured .m function files                                                            - UTIHELP             - 2023 Sep 08
%   publishFunctionAlpha           - Enables to create web page which contains the alphabetical list of functions                                                        - UTIHELP             - 2023 Sep 08
%   publishFunctionCate            - Enables to create web page which contains the categorical list of functions                                                         - UTIHELP             - 2023 Sep 08
...
%   randsampleFS                   - Generates a random sample of k elements from the integers 1 to n (k<=n)                                                             - UTICOMB             - 2023 Sep 08
...
%   resfwdplot                     - Plots the trajectories of the monitored scaled (squared) residuals                                                                  - VIS-Reg             - 2023 Jun 19
...
%   restrdeter                     - Computes determinant restriction                                                                                                    - CLUS-RobClaMULT     - 2023 Sep 08
%   restrdeterGPCM                 - Applies determinat restrictions for the 14 GPCM                                                                                     - CLUS-RobClaMULT     - 2023 Sep 08
%   restreigen                     - Computes eigenvalues restriction (without Dykstra algorithm)                                                                        - CLUS-RobClaMULT     - 2023 Sep 08
%   restreigeneasy                 - Computes eigenvalues restriction (without Dykstra algorithm)                                                                        - CLUS-RobClaMULT     - 2023 Sep 08
%   restreigenmemopt               - Computes eigenvalues restriction (without Dykstra algorithm)                                                                        - CLUS-RobClaMULT     - 2023 Sep 08
%   restrshapeExact                - Computes constrained Gamma (shape) matrix with exact constraints                                                                    - CLUS-RobClaMULT     - 2023 Sep 08
%   restrshapeGPCM                 - Produces the restricted shape matrix for the 14 GPCM                                                                                - CLUS-RobClaMULT     - 2023 Sep 08
%   restrSigmaGPCM                 - Computes constrained covariance matrices for the 14 GPCM specifications                                                             - CLUS-RobClaMULT     - 2023 Sep 08
...
%   rlga                           - Performs robust linear grouping analysis                                                                                            - CLUS-RobClaREG      - 2023 Sep 08
...
%   scatterboxplot                 - Creates scatter diagram with marginal boxplots                                                                                      - VIS-Mult            - 2023 Sep 20
...
%   setToolboxStartEnd             - Sets release compatibility in ToolboxPackagingConfiguration.prj file                                                                - UTIHELP             - 2023 Sep 08
%   shuffling                      - Does a random permutation of the elements of input vector                                                                           - UTICOMB             - 2023 Sep 08
%   simdataset                     - Simulates and-or contaminates a dataset given the parameters of a finite mixture model with Gaussian components                     - CLUS-MixSim         - 2023 Sep 08
%   simdatasetreg                  - Simulates a regression dataset given the parameters of a mixture regression model                                                   - CLUS-MixSim         - 2023 Sep 08
...
%   spmplot                        - Produces an interactive scatterplot matrix with boxplots or histograms on the main diagonal and possibly robust bivariate contours  - VIS-Mult            - 2023 Nov 01
...
%   subsets                        - Creates a matrix of indexes where rows are distinct p-subsets extracted from a set of n elements                                    - UTICOMB             - 2023 Sep 08
...
%   tclust                         - Computes trimmed clustering with scatter restrictions                                                                               - CLUS-RobClaMULT     - 2023 Sep 08
%   tclusteda                      - Computes tclust for a series of values of the trimming factor                                                                       - CLUS-RobClaMULT     - 2023 Sep 08
%   tclustIC                       - Computes tclust for different number of groups k and restriction factors c                                                          - CLUS-RobClaMULT     - 2023 Sep 08
%   tclustICgpcm                   - Computes tclust for different number of groups k and restr. factors $c_{det}$ and $c_{shw}$                                         - CLUS-RobClaMULT     - 2023 Sep 08
%   tclustICplot                   - Plots information criterion as a function of c and k                                                                                - VIS-Clu             - 2023 Sep 18
%   tclustICplotGPCM               - Plots information criterion as a function of  $c_{det}$, $c_{shw}$,  $c_{shb}$ and $k$                                              - VIS-Clu             - 2023 Apr 19
%   tclustICsol                    - Extracts a set of best relevant solutions                                                                                           - CLUS-RobClaMULT     - 2023 Sep 18
%   tclustICsolGPCM                - Extracts a set of best relevant solutions from 3D array computed using function tclustICgpcm                                        - CLUS-RobClaMULT     - 2023 Sep 08
%   tclustreg                      - Performs robust linear grouping analysis                                                                                            - CLUS-RobClaREG      - 2023 Sep 08
%   tclustregeda                   - Performs robust linear grouping analysis for a series of values of the trimming factor                                              - CLUS-RobClaREG      - 2023 Sep 08
%   tclustregIC                    - Computes tclustreg for different number of groups k and restriction factors c                                                       - CLUS-RobClaREG      - 2023 Sep 08
%   tkmeans                        - Computes trimmed k-means                                                                                                            - CLUS-RobClaMULT     - 2023 Sep 08
...
%   txmerge                        - Performs a (hierarchical) merging of the inflated number of components found by tkmeans or tclust                                   - CLUS-RobClaMULT     - 2023 Sep 08
...
%   wedgeplot                      - Generates the double wedge plot of a time series                                                                                    - VIS-Reg             - 2023 Oct 31
...
%   xmlcreateFS                    - Creates an XML file passing through publishFS                                                                                       - UTIHELP             - 2023 Sep 08
%   yXplot                         - Produces an interactive scatterplot of y against each variable of X in the input dataset                                            - VIS-Reg             - 2023 Nov 02
