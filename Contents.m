...
%-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
%   ace                          - Computes alternative conditional expectation                                                                                        - REG-Transformations - 2021 Apr 11
%   aceplot                      - Produces the aceplot to visualize the results of ace                                                                                - VIS-Reg             - 2021 Jun 04
...
%   avas                         - Computes additivity and variance stabilization for regression                                                                       - REG-Transformations - 2021 Apr 21
%   balloonplot                  - Creates a balloon plot of a contingency table                                                                                       - VIS-Mult            - 2021 Aug 19
...
%   CorAnaplot                   - Draws the Correspondence Analysis (CA) graphs with confidence ellipses                                                              - VIS-Mult            - 2021 Aug 28
...
%   ctlcurves                    - Computes Classification Trimmed Likelihood Curves                                                                                   - CLUS-RobClaMULT     - 2021 Jun 10
%   ctlcurvesplot                - Plots the output of routine ctlcurves                                                                                               - VIS-Clu             - 2021 Jun 10
...
%   fanBIC                       - Uses the output of FSRfan to choose the best value of the transformation parameter in linear regression                             - VIS-Reg             - 2021 Aug 24
%   fanBICpn                     - Uses the output of FSRfan called with input option family 'YJpn' to choose la_P and la_N                                            - VIS-Reg             - 2021 Aug 24
...
%   forecastTS                   - Forecast for a time series with trend, time varying seasonal, level shift and irregular component                                   - REG-Regression      - 2021 Aug 25
...
%   FSM                          - Computes forward search estimator in multivariate analysis                                                                          - MULT-Multivariate   - 2021 Aug 05
...
%   FSReda                       - Enables to monitor several quantities in each step of the forward search                                                            - REG-Regression      - 2021 Jul 16
...
%   FSRfan                       - Monitors the values of the score test statistic for each lambda                                                                     - REG-Transformations - 2021 Jul 30
...
%   LTSts                        - Extends LTS estimator to time series                                                                                                - REG-Regression      - 2021 Aug 12
...
%   malfwdplot                   - Plots the trajectories of scaled Mahalanobis distances along the search                                                             - VIS-Mult            - 2021 Aug 05
%   malindexplot                 - Plots the Mahalanobis distances versus a selected variable                                                                          - VIS-Mult            - 2021 Feb 01
%   mcd                          - Computes Minimum Covariance Determinant                                                                                             - MULT-Multivariate   - 2021 Aug 06
...
%   mdrplot                      - Plots the trajectory of minimum deletion residual (mdr)                                                                             - VIS-Reg             - 2021 Jul 23
...
%   moonplot                     - Draws the Correspondence Analysis (CA) moonplot                                                                                     - VIS-Mult            - 2021 Aug 27
...
%   publishFS                    - Enables to create automatic HELP FILES from structured .m function files                                                            - UTIHELP             - 2021 Aug 24
...
%   quickselectFS                - Finds the k-th order statistic                                                                                                      - UTIGEN              - 2021 Aug 19
...
%   restreigen                   - Computes eigenvalues restriction (without Dykstra algorithm)                                                                        - CLUS-RobClaMULT     - 2021 Jul 07
%   restreigeneasy               - Computes eigenvalues restriction (without Dykstra algorithm)                                                                        - CLUS-RobClaMULT     - 2021 Jul 06
...
%   restrSigmaGPCM               - Computes constrained covariance matrices for the 14 GPCM specifications                                                             - CLUS-RobClaMULT     - 2021 Jun 09
...
%   simulateTS                   - Simulates a time series with trend, time varying seasonal, level shift and irregular component                                      - REG-Regression      - 2021 Aug 25
...
%   spmplot                      - Produces an interactive scatterplot matrix with boxplots or histograms on the main diagonal and possibly robust bivariate contours  - VIS-Mult            - 2021 Apr 08
...
%   tclust                       - Computes trimmed clustering with scatter restrictions                                                                               - CLUS-RobClaMULT     - 2021 Jul 07
%   tclusteda                    - Computes tclust for a series of values of the trimming factor                                                                       - CLUS-RobClaMULT     - 2021 May 19
%   tclustIC                     - Computes tclust for different number of groups k and restriction factors c                                                          - CLUS-RobClaMULT     - 2021 Feb 01
%   tclustICgpcm                 - Computes tclust for different number of groups k and restr. factors $c_{det}$ and $c_{shw}$                                         - CLUS-RobClaMULT     - 2021 Jul 08
...
%   tclustreg                    - Performs robust linear grouping analysis                                                                                            - CLUS-RobClaREG      - 2021 Aug 19
