...
%%% copy d:\tmp\FSDAproject.prj ./bin/FSDA.mltbx
...
% 
[status,msg] = copyfile([FSDAProjFolder  fsep 'FSDAproject.prj'],FSrootGitHub);
% 
...
!git add FSDAproject.prj
!git commit -m "added last project file of FSDA for MATLAB Online"
!git push
% 
