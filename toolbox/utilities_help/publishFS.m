...
%             Consider the following example with these namepairs:
%             'outputDir'='C:\rosa','imagesDir','C:\rosa\images'
%             It is worth noting that the folder 'C:\rosa', 'C:\rosa\tmp'
...
%         For single line equations symbols backslash[ backslash] must be used if
%         no equation numbering is needed, otherwise the block backslash begin{equation} 
%         and backslash end{equation} is needed, and inside it, 
%         a backslash label{eqname} which should be referenced in the text by a 
%         backslash eqref{eqname}, which also creates a clickable link to the equation.
%         -----------------------------------------------------------------------:.
...
fstring=regexprep(fstring,'<','&lt;');
fstring=regexprep(fstring,'>','&gt;');
% replace if present symbol � with its HTML code
fstring=regexprep(fstring,'�','&uuml;');
...
if webhelp == true
    aftermetacontent=['." itemprop="description" name="description" />\r'...
        ...
        'MathJax.Hub.Config({\r'...
        'jax: ["input/TeX", "output/HTML-CSS"],\r'...
        'extensions: ["tex2jax.js", "TeX/AMSeqnum.js"],\r'...
        'tex2jax: {inlineMath: [["$","$"],["\\\\(","\\\\)"]]},\r'...
        'TeX: {\r'...
        'extensions: ["AMSsymbols.js"],\r'...
        'equationNumbers: { autoNumber: "AMS" }\r'...
        '}\r'...
        '});\r'...
        '</script>\r'...
        '<script>\r'...
        '(function() {\r'...
        'var cx = "007874165161426536790:d2xjm5ikfvg"; \r'...
        'var gcse = document.createElement("script"); \r'...
        'gcse.type = "text/javascript"; \r'...
        'gcse.async = true;\r'...
        'gcse.src = "https://cse.google.com/cse.js?cx=" + cx; \r'...
        'var s = document.getElementsByTagName("script")[0]; \r'...
        's.parentNode.insertBefore(gcse, s);\r'...
        '})();\r'...
        '</script>\r'...
        ...
        '<link href="../includes/product/css/site6_sm+xs.css" rel="stylesheet" media="screen and (max-width: 991px)"></link>\r'...
        '<link href="../includes/product/css/site6_sm.css" rel="stylesheet" media="screen and (min-width: 768px) and (max-width: 991px)"></link>\r'...
        '<link href="../includes/product/css/site6_xs.css" rel="stylesheet" media="screen and (max-width: 767px)"></link>\r'...
        '<link href="../includes/product/css/site6_offcanvas.css" rel="stylesheet" type="text/css"></link>\r'...
        '<script src="../includes/shared/scripts/l10n.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/docscripts.js"></script>\r'...
        '<script src="../includes/shared/scripts/docscripts_rn.js"></script>\r'...
        '<script src="../includes/shared/scripts/mw.imageanimation.js" type="text/javascript"></script>\r'...
        '<script src="../includes/shared/scripts/jquery.highlight.js"></script>\r'...
        '<script src="../includes/product/scripts/bootstrap.min.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/global.js"></script>\r'...
        '<script src="includesFS/bottom.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/underscore-min.js"></script>\r'...
        '<script src="../includes/shared/scripts/f1help.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/suggest.js" type="text/javascript"></script>\r'...
        '<script src="../includes/shared/scripts/helpservices.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/jquery/jquery.mobile.custom.min.js"></script>\r'...
        '<!-- the following 2 css files cannot be substituted by new css files-->\r'...
        '<link href="includesFS/doc_center.css" rel="stylesheet" type="text/css"></link>\r'...
    ...
    aftermetacontent=['." itemprop="description" name="description" />\r'...
        ...
        '<script src="../includes/shared/scripts/helpservices.js" type="text/javascript"></script>\r'...
        '<script src="../includes/product/scripts/jquery/jquery.mobile.custom.min.js"></script>\r'...
        '<!-- the following line should be kept this way only -->\r'...
        '<link href="includesFS/doc_center.css" rel="stylesheet" type="text/css"></link>\r'...
...
for i=1:nTOTargin
    ...
    if ~isempty(strfind(listInpArgs{i,3},'truct')) && contains(descrlong,'field')
...
if isempty(OptArgsVarargin)
    ...
    for i=1:size(listOptArgs,1)
        ...
        % ~isempty(strfind(shortdesc,'truct')) && ~isempty(strfind(listOptArgs{i,4},'field'))
        if contains(shortdesc,'truct') && ~isempty(strfind(listOptArgs{i,4},'field'))
...
%% CREATE ON THIS PAGE SECTION WHICH WILL APPEAR IN THE HEADER SECTION (Search)
...
if webhelp == true
    ...
    OnThisPageini=['<div id="doc_header_spacer" class="header"></div>\r' ...
        ...
        '<li role="presentation"> <a href="release_notes.html?s_cid=doc_flyout" role="menuitem" tabindex="-1"> Release Notes</a></li>\r'...
...
OnThisPagefin=['</ul>\r'...
    '</nav>\r'...
    '<script src="../includes/product/scripts/offcanvas.js"></script>\r'...
    '</div>'];
