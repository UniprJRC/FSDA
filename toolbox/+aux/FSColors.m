...
%
    ...
    enumeration
        ...
        white (1, 1, 1, 'w')
        black (0, 0, 0, 'k')
        brown (172/255, 115/255, 57/255, 'br')
        ...
        lightgrey (192/255, 192/255, 192/255,'lg')
        lightbrown (223/255, 191/255, 15/255,'lbr')
        darkblue (0, 0, 128/255, 'db')
        darkred (180/255,0,0,'dr')
        darkgreen (0,77/255,0,'dg')
        darkpurpl (100/255,0,130/255,'dp')
        darkyellow (204/255,204/255,0,'dy')
        darkgrey (0.6, 0.6, 0.6,'dg')
        darkbrown (115/255, 77/255, 38/255, 'dbr')
        darkcyan (0, 139/255, 139/255,'dc')
    ...
    %% REMARK:
    %  If you have a Release older than 2010b, you must comment the static
    %  methods definitions above and uncomment the methods below.
    %{
       methods(Static)
           % black and white
           function c = white
