...
% out comes from MMregeda or Sregeda or MDPDReda
...
if corres==true
    ...
    % The code below copies the resfwdplot into panels [1 3 5] of a new figure
    ax1 = gca; % get handle to axes of figurexx
