function odds = mFNChygeodds(mu, m, n)
%mFNChygeodds returns Fisher multivariate non-central hypergeometric odds given means
%
%<a href="matlab: docsearchFS('mFNChygeodds')">Link to the help function</a>
%
% This function calls function  oddsMFNCHypergeo_from_mean which is a
% translation into MATLAB of the corresponding C++ function of Fog (2008).
% The notation which is used in mFNChygeodds and the order of the arguments
...
%
%
% See also: WNChygepdf, WNChygecdf, WNChygeinv, WNChygernd, FNChygepdf, FNChygecdf, FNChygeinv, FNChygernd, mWNChygeodds
%
% References:
%
...
if nargin < 3
    error(message('FSDA:mFNChygeodds:TooFewInputs'));
end
odds = aux.oddsMFNCHypergeo_from_mean(mu,m,n);
