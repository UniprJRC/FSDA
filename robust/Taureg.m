...
%
%
%<a href="matlab: docsearch('taureg')">Link to the help function</a>
%
...
%            columns represent variables. If X is an empty matrix the
%            program will assign to X the sequence 1:n.
%
...
%      eff    : scalar defining nominal asymptotic efficiency
...
% Acknowledgements
%
% The kernel of the function is base on a MATLAB code downloaded from the
