...
% HYPeff                       - HYPeff finds constant c which is associated to the requested efficiency
% HYPk                         - HYPk computes breakdown point and efficiency associated with constant k=sup CVC for
...
% MMregcore                    - MMregcore computes MM regression estimators for a selected fixed scale.
...
% RobRegrSize                  - RobRegrSize provides proper threshold for robust estimators to obtain an empirical size = 1% nominal size
