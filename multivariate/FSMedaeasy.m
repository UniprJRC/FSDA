function out = FSMedaeasy(Y,bsb,varargin)
%FSMedaeasy is exactly equal to FSMeda but it is much less efficient
%
%
%<a href="matlab: docsearchFS('FSMedaeasy')">Link to the help function</a>
%
...
% out.class=    'FSMeda'
%
% See also FSMeda, FSMmmd.m, FSM.m
%
% References:
%
...
%{
    ...
    m0=20;
    bs=fre(1:m0,1);
    [out]=FSMedaeasy(Y,bs,'plots',1,'init',30);
%}
...
%{
    ...
    % Minimum Mahalanobis distance
    [out]=FSMedaeasy(Y1tr,bs,'init',100);
