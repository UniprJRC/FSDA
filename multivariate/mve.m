...
%               Number of subsamples of size v+1 which have to be extracted 
%               (if not given, default = 500).
%               Example - 'nsamp',10000 
%               Data Types - double
%
...
%               Default value of tolerance for the refining steps.
...
%    ysaveRAW : save input matrix. Scalar. Scalar that is set to 1 to
%               request that the data matrix Y is saved into the output
%               structure RAW. This feature is meant at simplifying the use
%               of function malindexplot. Default is 0, i.e. no saving is
%               done.
%               Example - 'ysaveRAW',1
%               Data Types - double
%
%    ysaveREW : save input matrix. Scalar. Scalar that is set to 1 to
%               request that the data matrix Y is saved into the output
%               structure REW. This feature is meant at simplifying the use
