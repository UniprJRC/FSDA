...
axis('off');
    ...
    function brushROBex(~,eventdata)
        ...
        getevent = get(eventdata.NewValue,'String');
        
        if strcmp(getevent,'Forbes dataset');
        ...
        elseif strcmp(getevent,'Multiple regression')
            ...
            % plot tresiduals using brushing
            databrush=struct;
            databrush.bivarfit='';
            databrush.selectionmode='Rect';
            databrush.persist='';
        ...
        elseif strcmp(getevent,'Multiple regression (2)')
            multiple_regression=load('multiple_regression.txt');
            y=multiple_regression(:,4);
            X=multiple_regression(:,1:3);
            % LMS using 1000 subsamples
        ...
        elseif strcmp(getevent,'Hawkins')
            %% Hawkins data
        ...
        elseif strcmp(getevent,'Stack loss (y)')
        ...
        elseif strcmp(getevent,'Stack loss (sqrt y)')
            ...
            databrush.selectionmode='Rect';
            databrush.persist='';
            %resplot(out,'databrush',{'bivarfit' '2' 'selectionmode','Rect','persist' '' 'Label' 'on' 'RemoveLabels' 'off'});
            resindexplot(out,'databrush',databrush);
