...
if strcmp(get(eventdata.NewValue,'String'),'Wool dataset');
    wool=load('wool.txt');
    y=wool(:,4);
    X=wool(:,1:3);
    [out]=FSRfan(y,X);
...
elseif strcmp(get(eventdata.NewValue,'String'),'Stack loss dataset')
...
elseif strcmp(get(eventdata.NewValue,'String'),'Loyalty cards')
