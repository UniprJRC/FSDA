...
%   logmvnpdfFS   - Produces log of Multivariate normal probability density function (pdf)                                                                                              - UTISTAT- 2016 May 25
%   mahalFS       - Computes Mahalanobis distances (in squared units) for each row of matrix Y                                                                                          - UTISTAT- 2016 May 17
%   Mscale        - Finds the M estimator of the scale                                                                                                                                  - UTISTAT- 2016 May 25
...
%   winsor        - Returns a copy of X in which all entries smaller than the p(1) quantile have been replaced by this value and likewise for all entries larger than the p(2) quantile - UTISTAT- 2016 May 11
