...
%winsorize returns a copy of X in which all entries smaller than the p(1) quantile have been replaced by this value and likewise for all entries larger than the p(2) quantile.
%
