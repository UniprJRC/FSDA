...
"C:\cygwin64\bin\sed.exe"  -i "s/AppVerName=FSDA toolbox Release .*/AppVerName=FSDA toolbox Release 2018a (%miadata%) for MATLAB (not earlier than R2009b) /" FSDAscript.iss
