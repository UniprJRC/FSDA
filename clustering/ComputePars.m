...
%
%       p  : scalar, dimensionality (number of variables)
%       k  : scalar, number of components (groups)
%       Pi : vector of length k containing mixing proportions
%       Mu : matrix of size k-by-p containing centroids of the k groups 
%       S  : 3D array of size p-by-p-by-k containing covariance matrices
%
%
%  Output:
%
%       li : 3D array of size k-by-k-by-p. li(i,j,:) is the vector which
...
%            l=1, 2, ...,p, where \gamma_l is the l-th eigenvector coming
