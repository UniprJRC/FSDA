...
% Connect_Matlab_with_R_HELP   - Connect_Matlab_with_R_HELP prepare connection with R in order to execute R commands from within MATLAB.
% demoMixSim                   - dempMixSim prepare connection with R
% estepFS                      - estepFS performs e-step for Gaussian mixture distribution
% GetOmegaMap                  - GetOmegaMap calculates the map of misclassificaton betweeb groups
...
% MixSim                       - MixSim generates k clusters in p dimensions with given overlap
