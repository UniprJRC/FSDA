...
%
% nnoise:       desired number of noise variables. Scalar.
%               Example - 'nnoise',2;
%               Data Types - double
% nout:           number of observations outside (1 - 'alpha') ellipsoidal contours for the
%                   weighted component distributions. Integer.
%               Example - 'nout',5;
%               Data Types - double
% alpha:        confidence level. Scalar.
%               Example - 'alpha',0.01;
%               Data Types - double
% int:             interval. Vector. If int is specified, noise will be
