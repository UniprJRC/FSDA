function y=Upmat2vec(A,k)
%Upmat2vec extracts in a vector the linear indexes or the elements on and above the k-th diagonal of a square matrix 
...
%               the procedure returns the (A*(A-1)/2)+A linear indexes
%               of the elements on and above diagonal.
%
%               If A is a square matrix of order r (r>1), the procedure
...
%  Output:
%
%        y  : vector containing the linear indexes or the elements on and above diagonal.
%
...
%
%       Remark: if the elements on and above diagonal must be extracted
%             repeatedly, it is convenient to find the linear indexes once
%             and for all
%
%       Remark 2: the linear indices of the upper tringualar part of a
