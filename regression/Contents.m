...
%   FSR              - Gives an automatic outlier detection procedure in linear regression                                                        - REG-Regression     - 2020 Apr 22
...
%   FSRbsb           - Returns the units belonging to the subset in each step of the forward search                                               - REG-Regression     - 2020 Apr 02
%   FSRcp            - Monitors Cp and AIC for all models of interest of size smallp                                                              - REG-ModelSelection - 2020 Apr 02
%   FSReda           - Enables to monitor several quantities in each step of the forward search                                                   - REG-Regression     - 2020 Apr 22
...
%   FSRfan           - Monitors the values of the score test statistic for each lambda                                                            - REG-Transformations- 2020 Apr 22
...
%   FSRmdr           - Computes minimum deletion residual and other basic linear regression quantities in each step of the search                 - REG-Regression     - 2020 Apr 21
...
%   LTSts            - Extends LTS estimator to time series                                                                                       - REG-Regression     - 2020 Apr 22
...
%   MMreg            - Computes MM estimator of regression coefficients                                                                           - REG-Regression     - 2020 Apr 22
%   MMregcore        - Computes MM regression estimators for a selected fixed scale                                                               - REG-Regression     - 2020 Apr 21
...
%   ScoreYJ          - Computes the score test for Yeo and Johnson transformation                                                                 - REG-Transformations- 2020 Apr 03
%   ScoreYJpn        - Computes the score test for YJ transformation separately for pos and neg observations                                      - REG-Transformations- 2020 Apr 22
%   simulateLM       - Simulate linear regression data                                                                                            - REG-Regression     - 2020 Mar 02
...
%   supsmu           - Smooths scatterplots using Friedman's supersmoother algorithm                                                              - REG-Transformations- 2020 Apr 22
...
%   VIOM             - Computes weights estimates under Variance-Inflation Model                                                                  - REG-Regression     - 2020 Apr 21
