...
%   FSRBeda                    - Enables to monitor several quantities in each step of the Bayesian search                                                  - REG-Bayes          - 2018 Jun 08
%   FSRBmdr                    - Computes minimum deletion residual and other basic linear regression quantities in each step of the Bayesian search        - REG-Bayes          - 2018 Jun 08
...
%   MMreg                      - Computes MM estimator of regression coefficients                                                                           - REG-Regression     - 2018 Jul 13
%   MMregcore                  - Computes MM regression estimators for a selected fixed scale                                                               - REG-Regression     - 2018 Jun 08
...
%   regressH                   - Fits a multiple linear regression model with heteroskedasticity                                                            - REG-Hetero         - 2018 Jun 08
%   regressHart                - Fits a multiple linear regression model using ART heteroskedasticity                                                       - REG-Hetero         - 2018 Jun 08
