...
if webhelp == true
    ...
    aftermetacontent=['." itemprop="description" name="description" />\r'...
        ...
        '<link href="includesFS/doc_center_installed.css" rel="stylesheet" type="text/css">\r'...
        '<link href="includes/product/css/doc_center_print.css" media="print" rel="stylesheet" type="text/css">\r'...
        '<link href="includesFS/default.css" rel="stylesheet" type="text/css">\r'...
        '</head>\r'...
        '<body  onload="highlightMATLABCode();" id="responsive_offcanvas">\r'];
        ...
        for i=1:length(sel)
            ...
            if ~isempty(incl)
                ...
                if ~isempty(PosStrBeforeFirstImage)
                    ...
                    Addafter=['Click here for the graphical output of this example (link to Ro.S.A. website)<br>' ...
                        'Graphical output could not be loaded locally because toolboxes cannot be greater than 20MG.\&#10; \xOA'...
                        'To load locally the images files, download zip file http://rosa.unipr.it/fsda/images.zip <br>'...
                        'and unzip it to (docroot)/FSDA/images <br> or simply run routine downloadGraphicalOutput.m'];
