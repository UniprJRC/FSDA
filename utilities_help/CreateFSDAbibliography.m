...
[FilesIncluded,FilesExcluded]=makecontentsfileFS('dirpath',list,'FilterFileContent','%FScategory:','force',false,'printOutputCell','Contents.m');
...
cits=refConv1(OUT, FilesIncluded);
[~,ia,~]=unique(cits(:,1));
