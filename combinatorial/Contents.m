...
%   lexunrank    - lexunrank(n,k,N) gives the k-combination of n elements of position N 
%   nchoosekFS   - nchoosekFS produces Binomial coefficient or matrix containing all combinations.
%   randsampleFS - randsampleFS generates a random sample of k elements from the integers 1 to n
